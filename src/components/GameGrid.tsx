        ...
        <section className="right">
          ...
          >
            ...
            {bullets1.map((bullet, index) => (
              <img
                ...
                style={{
                  position: "absolute",
                  left: `calc(28% + ${bullet.horizontal}px)`,
            ...
            {bullets2.map((bullet, index) => (
              <img
                ...
                style={{
                  position: "absolute",
                  left: `calc(72% + ${bullet.horizontal}px)`,
                  top: `calc(100% - ${bullet.vertical}px)`,
                  width: "12px",
                  height: "12px",
                  backgroundColor: "red",
          ...
          <div className="pros-cons-container">
            <div className="pros-cons">
              ...
              <div>
                {getProsAndCons("loadout1").pros.length > 0 ? (
                  ...
                  <p style={{ fontWeight: "bold" }}> No pros</p>
                )}
              </div>
              <div>
                {getProsAndCons("loadout1").cons.length > 0 ? (
                  getProsAndCons("loadout1").cons.map((pro, index) => (
                    <p key={index}>{pro}</p>
                  ))
                ) : (
                  <p style={{ fontWeight: "bold" }}>No cons</p>
                )}
              </div>
            </div>
            ...
            <div className="pros-cons">
              ...
              <div>
                {getProsAndCons("loadout2").cons.length > 0 ? (
                  getProsAndCons("loadout2").cons.map((pro, index) => (
                    <p key={index}>{pro}</p>
                  ))
                ) : (
                  <p style={{ fontWeight: "bold" }}>No cons</p>
